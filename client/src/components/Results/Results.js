  ...
  <Row>
    <Col s={4}>
      <Card header={<CardTitle reveal image={"http://via.placeholder.com/350x150"} waves='light' />}
        ...
        <Button className="btn-left" waves='light'>Upvote<Icon left>arrow_upward</Icon></Button>
        <Button className="btn-right" waves='light'>Downvote<Icon right>arrow_downward</Icon></Button>
      </Card>
    </Col>
  </Row>
);
